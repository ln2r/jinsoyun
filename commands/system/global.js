...
module.exports = class ResetNotificationCommand extends Command {
    ...
    async run(msg, args) {
        ...
        let systems = ["hunters_refugee", "koldrak_announce", "reset", "twitter", "bid", "daily", "drop", "dungeon", "event", "grandharvest", , "koldrak", "shackledisle", "market", "weekly", "who", "nickname", "radd", "raddonce", "reg", "rmessage", "rremove", "setting"];
